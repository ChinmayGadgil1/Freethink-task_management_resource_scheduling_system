<template>
  <q-page class="pm-page tasks-page pm-tasks-page">
    <!-- 1. PAGE HEADER -->
          ...
          <div class="col-grow column no-wrap kanban-column-body">
            ...
            <q-card-section class="column no-wrap col-grow kanban-tasks-scroll-area">
              ...
              >
                <!-- Card Header -->
                <div
                  class="row items-center justify-between no-wrap q-mb-xs"
                  style="flex-shrink: 0"
                >
                ...
                <div class="col-grow" style="overflow: hidden; min-height: 0">
                  ...
                  <div v-if="task.description" class="text-caption text-grey-6 ellipsis-2-lines">
                    {{ task.description }}
                  </div>
                </div>
      ...
      >
        ...
        <q-form @submit.prevent="handleUpdateTask">
          <q-card-section class="column q-gutter-y-md">
            ...
            <div class="row q-col-gutter-sm">
              <div class="col-12">
                <div v-if="editingTaskHasAssignees">
                  <q-input
                ...
                <div
                  v-else
                  class="q-pa-sm rounded-borders text-caption text-grey-7"
    ...
    >
      Are you sure you want to move task <strong>"{{ taskToDelete?.title }}"</strong> to the Recycle
      Bin?
    </ConfirmActionDialog>
...
const editingTaskHasAssignees = computed(() => {
  if (!editingTaskId.value) return false;
  const t = tasks.value.find((item) => item.task_id === editingTaskId.value);
  if (!t) return false;
  return Boolean(t.assigned_resource_ids && t.assigned_resource_ids.length > 0);
});
